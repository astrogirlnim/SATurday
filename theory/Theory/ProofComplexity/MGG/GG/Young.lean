/-
Factor-2 Gabber-Galil spectral analysis (Jimbo-Maruoka / Boppana).

Adapted from the Apache-2.0 formalization in girving/aks, AKS/MGG.
The bound is for shears (x ± 2y, y), (x ± (2y+1), y), (x, y ± 2x),
(x, y ± (2x+1)). It does not apply to the unit-shear `mggNeighbor`.

LOG: R2 manual port of the factor-2 Fourier and Young argument
-/

import Theory.ProofComplexity.MGG.GG.YoungDefs
