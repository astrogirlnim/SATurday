...
Conjecture: Any monotone circuit computing parity on 5 inputs
...
## Generated from
- Task: bet_a_monotone_n5_s1008
- Seed: 1008
- Template: monotone_parity

LOG: Generated conjecture for monotone parity lower bound (n=5)
-/

/-- Parity function on 5 inputs: returns true if odd number of inputs are true -/
def parity_5 (inputs : Fin 5 → Bool) : Bool :=
...
theorem monotone_parity_lower_bound_5_s1008 :
  ∀ (C : MonotoneCircuit),
    C.num_inputs = 5 →
    C.computes (parity_5) →
    C.size ≥ 2^5 := by
